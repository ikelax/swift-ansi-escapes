...
print(ANSIEscapeCode.iTerm.image(path: "Examples/Image/image.webp", options: ImageOptions(height: 10, width: 10, preserveAspectRatio: true))!)

// The aspect ratio is not respected. Thus, the image is stretched to fill the
// specified height and width.
print(ANSIEscapeCode.iTerm.image(path: "Examples/Image/image.webp", options: ImageOptions(height: 10, width: 10, preserveAspectRatio: false))!)
